...
type Tab = 'devices' | 'templates' | 'shortcuts' | 'view' | 'ai' | 'apiKey' | 'dashboard' | 'logs' | 'data';
        ...
        <div className="fixed inset-0 bg-black/60 z-30" onClick={onClose}>
            ...
            >
                ...
                <div className="border-b border-slate-700 px-4 flex flex-wrap">
                    ...
                    <TabButton active={activeTab === 'data'} onClick={() => setActiveTab('data')}>Projekt-Daten</TabButton>
                ...
                <div className="p-6 flex-grow overflow-y-auto custom-scrollbar">
                    ...
                    {activeTab === 'data' && <ProjectDataEditor />}
                    ...
                    {activeTab === 'logs' && <LoggingSettingsEditor />}
                </div>
            </div>
        </div>
    );
